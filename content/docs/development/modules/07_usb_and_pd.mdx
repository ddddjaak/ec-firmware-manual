...
- [Type-C 和 EC 端口控制器（TCPC）](https://chromium.googlesource.com/chromiumos/platform/ec/+/HEAD/docs/new_driver_tcpc) — TCPC 驱动开发指南
- [USB PD 调试](https://chromium.googlesource.com/chromiumos/platform/ec/+/HEAD/docs/usb-pd-debugging) — PD 故障排查方法
- [PD VDM](https://chromium.googlesource.com/chromiumos/platform/ec/+/HEAD/docs/pd_vdm) — VDM/SVDM 消息详解
...
- [Chromium OS 写保护文档](https://chromium.googlesource.com/chromiumos/docs/+/HEAD/write_protection)
