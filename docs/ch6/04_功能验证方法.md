<div class="chapter-header"><span class="chapter-num">06</span><span class="separator">/</span><a href="../index.md">首页</a><span class="separator">›</span><a href="index.md">调试与验证</a><span class="separator">›</span><span>功能验证方法 (电源、按键、风扇等)</span></div>
