<div class="chapter-header"><span class="chapter-num">07</span><span class="separator">/</span><a href="../index.md">首页</a><span class="separator">›</span><a href="index.md">移植与定制</a><span class="separator">›</span><span>设备树与驱动适配（Devicetree / Binding / Driver）</span></div>
