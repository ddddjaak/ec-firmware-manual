<div class="chapter-header"><span class="chapter-num">FM</span><span class="separator">/</span><a href="../index.md">首页</a><span class="separator">›</span><span>功能模块</span></div>

# 功能模块

EC 固件中各功能模块的设计与实现，涵盖 13 个应用子模块及 18 个驱动模块。
