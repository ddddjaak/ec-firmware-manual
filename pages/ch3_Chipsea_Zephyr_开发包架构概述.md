\page ch3_Chipsea_Zephyr_开发包架构概述 开发包架构概述
...
> 各模块的详细功能与使用方法见 [固件功能模块说明](ch4__xE5_x9B_xBA_xE4_xBB_xB6_xE5_x8A_x9F_xE8_x83_xBD_xE6\xA8_xA1_xE5\x9D_x97_xE8\xAF\xB4_xE6\x98\x8E.html)。
...
日常开发主要通过 `prj.conf` 启用/关闭功能模块，通过板级 `.dts` 文件调整硬件参数。Kconfig 配置语法、优先级机制与自定义方法详见第5章 [应用开发指南 → Kconfig 配置系统](ch5__xE5_xBA_x94_xE7_x94_xA8_xE5_xBC_x80_xE5_x8F_x91_xE6_x8C_x87_xE5_x8D_x97.html)。
